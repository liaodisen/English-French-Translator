...
train(english_file, en_vocab_size, en_model_name, en_model_type, en_character_coverage)

ch_vocab_size = 400
ch_model_name = 'fr'
ch_model_type = 'bpe'
ch_character_coverage = 1
train(french_file, ch_vocab_size, ch_model_name, ch_model_type, ch_character_coverage)